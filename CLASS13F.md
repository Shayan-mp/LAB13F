...
![](CLASS13F_files/figure-commonmark/unnamed-chunk-11-1.png)
...
![](CLASS13F_files/figure-commonmark/unnamed-chunk-12-1.png)
...
## Section 2. Pathway Analysis: KEGG pathways
...
```
    ...
    Info: Working in directory /Users/shayan/Desktop/BIMM143/Lab 13f
...
factors could cause differences between the two methods? the most
significant Entities p-value is Cell cycle Mitotic that is different
from KEGG result. The difference in result can be because of variety of
database and gene sets.
